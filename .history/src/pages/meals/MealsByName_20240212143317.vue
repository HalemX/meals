<template>
  <div class="lg:mx-20">
    <div class="p-8 pb-0">
      ...
      />
      <button
        class="special md:absolute transition ease-in-out delay-150 border-[#ef4444] bg-[#ef4444] hover:-translate-y-1 hover:scale-00 hover:bg-[#f87171] duration-300 text-white px-2 py-2 rounded"
      >
        Enter to Search
      </button>
    </div>
