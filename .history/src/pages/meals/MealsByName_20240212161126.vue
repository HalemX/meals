    ...
    <div class="p-8 pb-0">
      <form class="rounded border-2 border-gray-200 bg-white items-center">
        ...
        <button
          ...
          class="md:w-[20%] transition ease-in-out delay-150 sm:mt-2 border-[#ef4444] bg-[#ef4444] hover:scale-105 hover:bg-[#f87171] duration-300 text-white px-3 py-1 rounded"
        >
          Enter to Search
        </button>
      </form>
