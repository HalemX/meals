<template>
  <div class="lg:mx-20">
    <div class="p-8 pb-0">
      <form class="rounded border-2 border-gray-200 bg-white flex">
        <input
          type="text"
        ...
        <button
          ...
          class="md:mb-2 mx-2 px-3 transition ease-in-out delay-150 sm:mt-2 border-[#ef4444] bg-[#ef4444] hover:scale-105 hover:bg-[#f87171] duration-300 text-white py-1 rounded"
        >
          Enter to Search
        </button>
      </form>
