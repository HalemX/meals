<template>
  <div class="lg:mx-20">
    <div class="p-8 pb-0">
      ...
      />
      <button class="special md:absolute class="transition ease-in-out delay-150 border-[#ef4444] bg-[#ef4444] hover:-translate-y-1 hover:scale-110 hover:bg-[#f87171] duration-300 text-white px-2 m-2 mx-3 py-2 rounded border-2 border-0">Enter to Search</button>
    </div>
