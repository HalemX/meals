<template>
  <div class="md:mx-20 p-8">
    ...
    >
      ...
      <div class="rounded-lg flex md:justify-end sm:justify-center">
        <img
          :src="meal.strMealThumb"
          :alt="meal.strMeal"
          class="max-w[100%] rounded-lg w-[70%]"
        />
      </div>
    </div>

    <div
      class="my-3 bg-[#ef4444] text-white p-5 rounded md:leading-loose sm:text-left"
    >
