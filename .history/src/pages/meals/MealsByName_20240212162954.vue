    ...
    <div class="p-8 pb-0">
      ...
      >
        ...
        <button
          ...
          class="w-20% sm:w-[30%] md:w-[20%] sm:mb-2 mx-2 transition ease-in-out delay-150 sm:mt-2 border-[#ef4444] bg-[#ef4444] hover:scale-105 hover:bg-[#f87171] duration-300 text-white py-1 rounded"
        >
          Enter to Search
        </button>
      </form>
