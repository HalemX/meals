  ...
  <div class="p-8 lg:mx-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
      <router-link
        ...
        v-for="ingredient of perfectIng"
  ...
  setup() {
    ...
    onMounted(() => {
      axiosClient.get("list.php?i=list").then(({ data }) => {
        ...
        perfectIng.value = hasIngDesc.value.filter((perfIng) => {
          return perfIng.strDescription.length > 10000;
        });
      });
    });

    return { ingredients, hasIngDesc, perfectIng };
  },
};
</script>
