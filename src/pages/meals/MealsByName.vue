<template>
  <div class="lg:mx-20">
    <div class="p-8 pb-0">
      <div
        class="form rounded border-2 border-gray-200 bg-white flex"
    ...
    <meals-item v-if="!emptyEnter" :meals="mealsByName"
      >please enter name of meal.</meals-item
    >

    <p v-else class="error text-[#ff0000] mt-2 px-8">
      Must Enter Name of Meal!
    </p>
  </div>
</template>
