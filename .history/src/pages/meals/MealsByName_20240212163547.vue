<template>
  <div class="lg:mx-20">
    <div class="p-8 pb-0">
      <form
        class="rounded sm:border-2 sm:border-gray-200 sm:bg-white flex flex-col sm:flex-row"
      >
        <input
          type="text"
          class="w-[800px] rounded border-2 border-gray-200"
        ...
        <button
          ...
          class="sm:mb-2 mx-2 px-3 transition ease-in-out delay-150 sm:mt-2 border-[#ef4444] bg-[#ef4444] hover:scale-105 hover:bg-[#f87171] duration-300 text-white py-1 rounded"
        >
          Enter to Search
        </button>
      </form>
