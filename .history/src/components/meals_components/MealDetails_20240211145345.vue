<template>
  <div class="md:mx-20 p-8">
    ...
    >
      <div class="heading md:mx-10 sm:text-center w-full">
      ...
      <div class="rounded-lg flex justify-center md:justify-end justify-start">
        <img
          :src="meal.strMealThumb"
          :alt="meal.strMeal"
          class="max-w[100%] rounded-lg md:w-[85%] w-[70%]"
        />
      </div>
    </div>

    <div class="my-3 bg-[#ef4444] text-white p-5 rounded md:leading-loose">
